...
public class AbilityExtension_GiveMentalState : AbilityExtension_AbilityMod
{
    ...
    public override void Cast(GlobalTargetInfo[] targets, Ability ability)
    {
        ...
        foreach (var target in targets)
        {
            ...
            TryGiveMentalStateWithDuration(
                pawn.RaceProps.IsMechanoid ? stateDefForMechs ?? stateDef : stateDef,
                pawn,
                ability,
                durationMultiplier,
                durationScalesWithCaster
            );
    ...
    public static void TryGiveMentalStateWithDuration(
        MentalStateDef def,
        Pawn p,
        Ability ability,
        StatDef multiplierStat,
        bool durationScalesWithCaster
    )
    {
        if (
