namespace VanillaPsycastsExpanded.Wildspeaker
{
    ...
    public class Ability_SummonPack : Ability
    {
        public override void Cast(params GlobalTargetInfo[] targets)
        {
            ...
            while (
                points > 0
                && ManhunterPackIncidentUtility.TryFindManhunterAnimalKind(
                    points,
                    map.Tile,
            ...
            )
            {
                ...
                Pawn animal = PawnGenerator.GeneratePawn(
                    new PawnGenerationRequest(kind, tile: map.Tile)
                );
                animals.Add(animal);
            }
            ...
            Find.LetterStack.ReceiveLetter(
                ...
                "VPE.PackSummon.Desc".Translate(this.pawn.NameShortColored),
