namespace VanillaPsycastsExpanded.Staticlord
{
    ...
    public class BallLightning : Projectile
    {
                    ...
                    thing
                        .TakeDamage(
                            new DamageInfo(
                                ...
                                12f,
                                5f,
                                this.DrawPos.AngleToFlat(thing.DrawPos),
                                this
                            )
                        )
        ...
        public override void Draw()
        {
            ...
            Vector3 a =
                this.DrawPos.Yto0()
                + new Vector3(1f, 0f, 0f).RotatedBy(this.origin.AngleToFlat(this.destination));
            ...
            foreach (Thing thing in this.currentTargets)
            {
                ...
                Matrix4x4 matrix = Matrix4x4.TRS(
                    a + (b - a) / 2 + Vector3.up * (this.def.Altitude - Altitudes.AltInc / 2),
        ...
        protected override void Impact(Thing hitThing)
        {
            GenExplosion.DoExplosion(
                ...
                this.origin.AngleToFlat(this.destination)
            );
        ...
        public override void ExposeData()
        {
            ...
            Scribe_Collections.Look(
                ref this.currentTargets,
                nameof(this.currentTargets),
                LookMode.Reference
            );
        }
    }
