...
public class FocusStrengthOffset_NearbyOfTechlevel : FocusStrengthOffset
{
    ...
    public override string GetExplanation(Thing parent)
    {
        ...
        return "VPE.ThingsOfLevel".Translate(num, this.techLevel.ToString())
            + ": "
    ...
    protected virtual List<Thing> GetThings(IntVec3 cell, Map map)
    {
        return GenRadialCached
            .RadialDistinctThingsAround(cell, map, this.radius, true)
            .Where(t => t.def.techLevel == this.techLevel)
            .Take(10)
            .ToList();
    }
}
