namespace VanillaPsycastsExpanded
{
    ...
    public class Ability_AggressiveHeatDump : Ability
    {
        public override void Cast(params GlobalTargetInfo[] targets)
        {
            ...
            var explosionRadius = Mathf.Min(
                Mathf.Ceil(this.pawn.psychicEntropy.EntropyValue / 20f),
                9f
            );
            ...
            MakeStaticFleck(
                targets[0].Cell,
                targets[0].Thing.Map,
                VPE_DefOf.VPE_AggresiveHeatDump,
                explosionRadius,
                0
            );
            GenExplosion.DoExplosion(
                ...
                DamageDefOf.Flame,
                pawn,
                (int)(DamageDefOf.Flame.defaultDamage * damageMultiplier),
