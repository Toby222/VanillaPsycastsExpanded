...
public class AbilityExtension_WordOfLove : AbilityExtension_AbilityMod
{
    ...
    public override void Cast(GlobalTargetInfo[] targets, Ability ability)
    {
        ...
        var hediff_PsychicLove = (Hediff_PsychicLove)
            HediffMaker.MakeHediff(HediffDefOf.PsychicLove, pawn, pawn.health.hediffSet.GetBrain());
    ...
    )
    {
        ...
        if (targets.Any())
        {
            ...
            if (pawn != null && pawn2 != null && !pawn.story.traits.HasTrait(TraitDefOf.Bisexual))
            {
                ...
                var gender2 = pawn.story.traits.HasTrait(TraitDefOf.Gay)
                    ? gender
                    : gender.Opposite();
