namespace VanillaPsycastsExpanded
{
    ...
    public class Hediff_IceShield : Hediff_Overlay
    {
        ...
        {
            base.PostAdd(dinfo);
            var coldHediffs = this
                .pawn.health.hediffSet.hediffs.Where(x =>
                    x.def == HediffDefOf.Hypothermia
                    || x.def == VPE_DefOf.VFEP_HypothermicSlowdown
                    || x.def == VPE_DefOf.HypothermicSlowdown
                )
                .ToList();
        ...
        public override void Notify_PawnPostApplyDamage(DamageInfo dinfo, float totalDamageDealt)
        {
            ...
            if (
                ...
                && Vector3.Distance(attacker.DrawPos, pawn.DrawPos) <= OverlaySize
